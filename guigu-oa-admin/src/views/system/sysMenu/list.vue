  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="180" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button type="success" v-if="scope.row.type !== 2" 
          icon="el-icon-plus" size="mini" :disabled="$hasBP('bnt.sysMenu.add')  === false"
          @click="add(scope.row)" title="添加下级节点"/>
          <el-button type="primary" icon="el-icon-edit" size="mini" :disabled="$hasBP('bnt.sysMenu.update')  === false"
